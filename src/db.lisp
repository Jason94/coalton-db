...
(coalton-toplevel
  ...
  (declare relationship-foreign-key (Relationship -> List TableFlag))
  (define (relationship-foreign-key rltn)
    ...
    (match rltn
      ...
      ((BelongsTo_ other-tbl-name key-pairs)
       (make-list
        (ForeignKey% other-tbl-name key-pairs)))))
...
definitions, etc."
    (<> (.flags table) (>>= (.relationships table) relationship-foreign-key)))
